...
function setup() {
  ...
  brushSize.position(10, 260);
  brushOpacity.position(10, 280);
  ...
  saveButton.position(10, 240);
  saveButton.mousePressed(saveImage);
  //New Brushes button
  nbButton = createButton("New Brushes");
  nbButton.position(60, 240); // Adjust position as needed
  nbButton.mousePressed(newBrushes);
  //Clear Canvas button
  clearButton = createButton("Clear Canvas");
  clearButton.position(155, 240); // Adjust position as needed
